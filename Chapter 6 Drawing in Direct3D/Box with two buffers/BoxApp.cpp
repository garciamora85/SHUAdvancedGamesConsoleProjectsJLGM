...
private:
    ...
    std::vector<D3D12_INPUT_ELEMENT_DESC> mInputPosLayout;
    std::vector<D3D12_INPUT_ELEMENT_DESC> mInputColLayout;
...
void BoxApp::BuildBoxGeometry()
{
    ...
    std::array<VColorData, 8> colors = {
      VColorData({XMFLOAT4(1.0f, 0.0f, 1.0f, 0.f)}),
      VColorData({XMFLOAT4(1.0f, 0.0f, 1.0f, 0.f)}),
      VColorData({XMFLOAT4(1.0f, 0.0f, 1.0f, 0.f)}),
      VColorData({XMFLOAT4(1.0f, 0.0f, 1.0f, 0.f)}),
      VColorData({XMFLOAT4(1.0f, 0.0f, 1.0f, 0.f)}),
...
void BoxApp::BuildPSO()
{
    ...
    psoDesc.InputLayout = { mInputPosLayout.data(), (UINT)mInputPosLayout.size() };
    //psoDesc.InputLayout = { mInputColLayout.data(), (UINT)mInputColLayout.size() };
