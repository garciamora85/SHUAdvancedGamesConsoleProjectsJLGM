...
void CrateApp::LoadTextures() //Primero lo cargas
{
...
void CrateApp::BuildRootSignature()
{
	...
	texTable.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 2, 0); //Acuerdate de decirle cuantos elementos tiene la texture table
...
void CrateApp::BuildDescriptorHeaps()
{
	...
	md3dDevice->CreateShaderResourceView(woodCrateTex2.Get(), &srvDesc2, hDescriptor2);
}
...
void CrateApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
    ...
    for(size_t i = 0; i < ritems.size(); ++i)
    {
		...
		D3D12_GPU_DESCRIPTOR_HANDLE dh = mSrvDescriptorHeap->GetGPUDescriptorHandleForHeapStart();

		CD3DX12_GPU_DESCRIPTOR_HANDLE tex2(dh);
		tex2.Offset(ri->Mat->DiffuseSrvHeapIndex, mCbvSrvDescriptorSize);
