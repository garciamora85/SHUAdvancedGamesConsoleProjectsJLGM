...
cbuffer cbPass : register(b1)
{
	...
	float4 gFogLinearColor;
	float4 gFogPow1Color;
	float4 gFogPow2Color;
	float gFogLinearStart;
	float gFogPow1Start;
	float gFogPow2Start;
	float gFogRange;
  float gFogDensity1;
  ...
  float gFogExponential1;
  float gFogExponential2;
  float3 cbPerObjectPad;
...
float4 PS(VertexOut pin) : SV_Target
{
    ...
    litColor = lerp(litColor, gFogPow2Color, powerFog2);
#endif
