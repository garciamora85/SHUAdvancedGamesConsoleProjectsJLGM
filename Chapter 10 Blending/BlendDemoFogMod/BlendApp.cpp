...
void BlendApp::Draw(const GameTimer& gt)
{
    ...
    mCommandList->ClearRenderTargetView(CurrentBackBufferView(), (float*)&mMainPassCB.gFogLinearColor, 0, nullptr);
...
void BlendApp::BuildLandGeometry()
{
    ...
    GeometryGenerator::MeshData grid = geoGen.CreateGrid(320.0f, 320.0f, 50, 50);
